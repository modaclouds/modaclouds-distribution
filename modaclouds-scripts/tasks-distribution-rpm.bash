...
modaclouds-distribution@components-rpm@${_task} : \
		...
		modaclouds-components-fg-analyzer-rpm@${_task} \
		modaclouds-components-fg-local-db-rpm@${_task} \
		...
		modaclouds-components-models-at-runtime-rpm@${_task} \
		modaclouds-components-monitoring-dda-rpm@${_task} \
		modaclouds-components-monitoring-history-db-rpm@${_task} \
		...
		modaclouds-components-sla-core-rpm@${_task} \
